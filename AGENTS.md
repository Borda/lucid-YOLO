...
- No commit message references the Ultralytics repository; papers cited by arXiv id. Hash-sign and at-sign characters never appear in subject or body (co-author trailer emails and the `Signed-off-by:` address are the two exceptions).

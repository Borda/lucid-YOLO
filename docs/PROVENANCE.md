...
| R21 | fuse-augmentations, github.com/Borda/fuse-augmentations, commit 74af9855325adcd92399d1b95d8458a9d236f129, Apache-2.0 | Synthetic scene generator for test fixtures and dataset stand-ins (A26), pinned via git commit (WP-131) rather than a PyPI version since the version string does not move release to release. No YOLO-implementation lineage; verified Apache-2.0 |

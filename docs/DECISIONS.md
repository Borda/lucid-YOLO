...
| D7 | Identity | Repository/package name `lit-yolo` (personal repository; employer sign-off required before any organizational nexus). "YOLO" used as the model-family/category term; naming evidence in docs/PROVENANCE.md. "YOLO26" and "Ultralytics" never appear in package, module, or model identifiers. |
...
| O2 | Project name | resolved 2026-07-30 | `lit-yolo`; YOLO26 implementation exposed under feature name `e2e` |

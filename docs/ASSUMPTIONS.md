...
| A31 | From-scratch stabilization beyond init not restated | Global gradient-norm clipping at 10.0 via the trainer for tier/overfit runs; generic deep-learning practice, not lineage-specific. 30-step real-COCO check: descending loss, box predictions bounded within image scale. The warmup half of this gap landed with the A8 schedule (WP-072) | gap; standard practice | Det-A stable-training criterion | active |

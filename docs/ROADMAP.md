...
| 053b | `feat(eval): segm evaluation, both paths` | Ground-truth masks from COCO polygons; evaluator scores bbox and segm on the top-k and NMS paths | `test_seg_eval.py::test_bbox_and_segm` | 053 | ⬜ |

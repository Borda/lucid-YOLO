...
| 045 | `exp(det): Det-A smoke tier and report section` [GPU][HUMAN] | n-scale ~50 epochs; Det-A criteria; report + model card (attempt 1, 2026-08-03: NOT accepted — mAP50-95 3.96 vs >25, constant-LR diagnosis; record in `.experiments/det_a/`) | Det-A acceptance met; artifacts archived with seeds/configs | 044,040,072 | ⬜ |

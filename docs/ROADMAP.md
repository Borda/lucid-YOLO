...
| 045 | `exp(det): Det-A smoke tier and report section` [GPU][HUMAN] | n-scale ~50 epochs; Det-A criteria; report + model card (attempts 1-2, 2026-08-03/04: NOT accepted — mAP50-95 3.96 / 6.28 vs >25; root cause = pixel-frame L1, fixed in WP-078; records in `.experiments/det_a/`) | Det-A acceptance met; artifacts archived with seeds/configs | 044,040,072,078 | ⬜ |

...
def test_warmup_decay_factor_endpoints(step: int, total: int, warmup: int, lrf: float, expected: float) -> None:
...
def test_warmup_decay_factor_is_monotonic_after_warmup() -> None:
...
def test_configure_optimizers_without_trainer_returns_bare_musgd() -> None:
...
def test_configure_optimizers_with_trainer_pairs_step_lambda_lr(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_configure_optimizers_schedule_disabled_returns_bare_musgd() -> None:

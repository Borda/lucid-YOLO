...
Covers :class:`lucid_yolo.models.DetectionNeck`: that the three outputs preserve the
...
from lucid_yolo.models import DetectionBackbone, DetectionNeck, PSABlock

...
:class:`~lit_yolo.losses.progressive.ProgressiveLossSchedule` delegating to the
pure function, and the module wiring: a three-epoch ``Trainer`` run steps
:attr:`~lit_yolo.ptl.module.DetectionLitModule.alpha` through the exact schedule
...
from lit_yolo.losses import ProgressiveLossSchedule, progressive_alpha

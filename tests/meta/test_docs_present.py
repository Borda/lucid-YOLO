...
def test_roadmap_wp_ids_unique_and_complete() -> None:
    """ROADMAP.md rows carry WP ids 001..075, each exactly once (068-075 added 2026-08-02..04)."""
    ...
    assert sorted(ids) == list(range(1, 76)), f"roadmap must list WP 001-075, got {len(ids)} rows"

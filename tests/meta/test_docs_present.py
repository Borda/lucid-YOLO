...
def test_roadmap_wp_ids_unique_and_complete() -> None:
    """ROADMAP.md rows carry WP ids 001..073, each exactly once (068-073 added 2026-08-02..04)."""
    ...
    assert sorted(ids) == list(range(1, 74)), f"roadmap must list WP 001-073, got {len(ids)} rows"

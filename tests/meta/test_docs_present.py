...
def test_roadmap_wp_ids_unique_and_complete() -> None:
    """ROADMAP.md rows carry WP ids 001..082, each exactly once (068-082 added 2026-08-02..06)."""
    ...
    assert sorted(ids) == list(range(1, 83)), f"roadmap must list WP 001-082, got {len(ids)} rows"

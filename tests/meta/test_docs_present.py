...
def test_roadmap_wp_ids_unique_and_complete() -> None:
    """ROADMAP.md rows carry WP ids 001..072, each exactly once (068-072 added 2026-08-02/03)."""
    ...
    assert sorted(ids) == list(range(1, 73)), f"roadmap must list WP 001-072, got {len(ids)} rows"

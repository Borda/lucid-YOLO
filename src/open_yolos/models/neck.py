...
WP-016…WP-019 primitives (:class:`~open_yolos.models.blocks.C3k2`,
:class:`~open_yolos.models.blocks.C3k`, :class:`~open_yolos.models.blocks.PSABlock`,
:class:`~open_yolos.models.blocks.ConvBNAct`) into the stack of blueprint sec. 5.3.
...
The final ``C3k2`` carries a :class:`~open_yolos.models.blocks.PSABlock` attention
...
``c3k=True`` :class:`~open_yolos.models.blocks.C3k` followed by a
:class:`~open_yolos.models.blocks.PSABlock` on its output.
...
from open_yolos.models.backbone import _scale_channels, _scale_repeats
from open_yolos.models.blocks import C3k, C3k2, ConvBNAct, PSABlock
...
def _attn_inner_factory(hidden_channels: int, shortcut: bool) -> nn.Module:
    ...
    The composite is the ``c3k=True`` inner unit — a :class:`~open_yolos.models.blocks.C3k`
    with ``n=2`` and ``expansion=0.5`` — followed by a
    :class:`~open_yolos.models.blocks.PSABlock` on its output, matching the attention
    tail of blueprint sec. 5.3. It is passed to :class:`~open_yolos.models.blocks.C3k2`

...
primitives (:class:`~open_yolos.models.blocks.ConvBNAct`,
:class:`~open_yolos.models.blocks.C3k2`, :class:`~open_yolos.models.blocks.SPPF`,
:class:`~open_yolos.models.blocks.C2PSA`) into the stack of blueprint sec. 5.2. Five
...
from open_yolos.models.blocks import C2PSA, SPPF, C3k2, ConvBNAct

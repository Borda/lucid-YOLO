...
:class:`~open_yolos.losses.dual_loss.DualBranchLoss` (via
:attr:`~open_yolos.ptl.module.DetectionLitModule.alpha`); the Lightning
...
class ProgressiveLossSchedule:
    ...
    the :class:`~open_yolos.ptl.module.DetectionLitModule` ``on_train_epoch_start``

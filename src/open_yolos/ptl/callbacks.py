...
class _SupportsMosaicProb(Protocol):
    ...
    :class:`~open_yolos.ptl.datamodule.DetectionDataModule`, but also a test stub)
...
class CloseMosaicCallback(Callback):
    ...
    datamodule's :meth:`~open_yolos.ptl.datamodule.DetectionDataModule.set_mosaic_prob`
    ...
    def _mosaic_datamodule(trainer: Trainer) -> _SupportsMosaicProb | None:
        ...
        Prefers a concrete :class:`~open_yolos.ptl.datamodule.DetectionDataModule`
...
class EMACallback(Callback):
    ...
    Examples:
        ```pycon
        >>> from open_yolos.ptl.callbacks import EMACallback

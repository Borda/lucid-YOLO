...
class TaskAlignedAssigner:
    ...
    def __call__(
        ...
        Args:
            ...
            anchor_points: ``(A, 2)`` anchor-centre ``(x, y)`` pixels, shared
                across the batch (see :func:`open_yolos.assign.make_anchor_points`).
    ...
    def _candidate_mask(self, anchor_points: Tensor, gt_boxes: Tensor, gt_mask: Tensor) -> Tensor:
        ...
        Subclasses (see :class:`open_yolos.assign.stal.SmallTargetAssigner`) override
    ...
    def _finalize_mask(self, mask_pos: Tensor, align_metric: Tensor) -> Tensor:
        ...
        reduce the mask further (see :class:`open_yolos.assign.one_to_one.UniqueAssigner`,

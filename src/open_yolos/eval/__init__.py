...
(:class:`~open_yolos.eval.coco_eval.DualPathEvaluator`), with the A9-tuple to
torchmetrics-prediction conversion
(:func:`~open_yolos.eval.coco_eval.detections_to_predictions`) and the
:class:`torchmetrics.detection.MeanAveragePrecision` wrapper
(:func:`~open_yolos.eval.coco_eval.evaluate_bbox`).
"""

from open_yolos.eval.coco_eval import DualPathEvaluator, detections_to_predictions, evaluate_bbox

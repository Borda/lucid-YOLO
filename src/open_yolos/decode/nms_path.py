...
:class:`~open_yolos.decode.topk_e2e.TopKDecoder` keeps two heavily overlapping
...
from open_yolos.decode.common import pad_detections
from open_yolos.models.heads.detect import decode_ltrb
...
class NMSDecoder(nn.Module):
    ...
    :class:`~open_yolos.decode.topk_e2e.TopKDecoder` so both paths feed one

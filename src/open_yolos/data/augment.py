...
Two more :class:`~open_yolos.data.transforms.GeometricTransform` implementations from
...
:class:`HSVJitter`
    ...
    colour change, so the :class:`~open_yolos.data.targets.Targets` pass straight
...
:class:`HorizontalFlip`
    ...
    long-edge representation, so — unlike :class:`~open_yolos.data.affine.RandomAffine` —
...
class HorizontalFlip:
    ...
    is no rotated-box guard here (contrast :class:`~open_yolos.data.affine.RandomAffine`).

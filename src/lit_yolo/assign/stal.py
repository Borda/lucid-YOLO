...
minimal, surgical modification of the Task-Aligned Assigner (:mod:`lit_yolo.assign.tal`):
...
from lit_yolo.assign.tal import TaskAlignedAssigner
...
class SmallTargetAssigner(TaskAlignedAssigner):
    ...
    Identical to :class:`~lit_yolo.assign.tal.TaskAlignedAssigner` except that the

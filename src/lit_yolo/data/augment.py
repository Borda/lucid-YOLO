...
Two more :class:`~lit_yolo.data.transforms.GeometricTransform` implementations from
...
:class:`HSVJitter`
    ...
    colour change, so the :class:`~lit_yolo.data.targets.Targets` pass straight
...
:class:`HorizontalFlip`
    ...
    long-edge representation, so — unlike :class:`~lit_yolo.data.affine.RandomAffine` —
...
class HorizontalFlip:
    ...
    is no rotated-box guard here (contrast :class:`~lit_yolo.data.affine.RandomAffine`).

...
:class:`~lit_yolo.data.transforms.GeometricTransform`: one call warps the image
and every modality carried by :class:`~lit_yolo.data.targets.Targets` (boxes,
polygons, rotated boxes) through the *same* affine, routed via
:func:`~lit_yolo.data.transforms.apply_affine_to_points` so the three paths share
...
from lit_yolo.data.transforms import apply_affine_to_points

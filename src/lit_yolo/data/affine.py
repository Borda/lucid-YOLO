...
:func:`~lit_yolo.data.transforms.apply_affine_to_points` exactly as WP-009's
:class:`~lit_yolo.data.letterbox.Letterbox` does — is what keeps boxes, polygons
...
Targets:
    ...
    :func:`~lit_yolo.data.transforms.boxes_from_polygons` — so mask/box agreement
    ...
    :meth:`~lit_yolo.data.targets.Targets.filter`.
...
from lit_yolo.data.transforms import apply_affine_to_points, boxes_from_polygons

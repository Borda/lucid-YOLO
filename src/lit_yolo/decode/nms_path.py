...
:class:`~lit_yolo.decode.topk_e2e.TopKDecoder` keeps two heavily overlapping
...
from lit_yolo.decode.common import pad_detections
from lit_yolo.models.heads.detect import decode_ltrb
...
class NMSDecoder(nn.Module):
    ...
    :class:`~lit_yolo.decode.topk_e2e.TopKDecoder` so both paths feed one

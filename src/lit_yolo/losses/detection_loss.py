...
:class:`~lit_yolo.assign.tal.AssignResult` produced for that branch and returns
...
- ``L_box`` — Complete-IoU loss (A1; :func:`lit_yolo.losses.ciou.ciou_loss`) on
...
from lit_yolo.assign.tal import AssignResult
from lit_yolo.losses.ciou import ciou_loss
...
class DetectionBranchLoss:
    ...
    def __call__(self, pred_logits: Tensor, pred_boxes: Tensor, assign: AssignResult) -> DetectionLossOutput:
        ...
        Args:
            ...
            assign: The :class:`~lit_yolo.assign.tal.AssignResult` for this

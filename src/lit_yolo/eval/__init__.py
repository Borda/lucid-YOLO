...
(:func:`~lit_yolo.eval.coco_eval.detections_to_predictions`) and the
:class:`torchmetrics.detection.MeanAveragePrecision` wrapper
(:func:`~lit_yolo.eval.coco_eval.evaluate_bbox`).
"""

from lit_yolo.eval.coco_eval import DualPathEvaluator, detections_to_predictions, evaluate_bbox

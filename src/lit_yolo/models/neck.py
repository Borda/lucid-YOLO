...
WP-016…WP-019 primitives (:class:`~lit_yolo.models.blocks.C3k2`,
:class:`~lit_yolo.models.blocks.C3k`, :class:`~lit_yolo.models.blocks.PSABlock`,
:class:`~lit_yolo.models.blocks.ConvBNAct`) into the stack of blueprint sec. 5.3.
...
The final ``C3k2`` carries a :class:`~lit_yolo.models.blocks.PSABlock` attention
...
``c3k=True`` :class:`~lit_yolo.models.blocks.C3k` followed by a
:class:`~lit_yolo.models.blocks.PSABlock` on its output.
...
from lit_yolo.models.backbone import _scale_channels, _scale_repeats
from lit_yolo.models.blocks import C3k, C3k2, ConvBNAct, PSABlock
...
def _attn_inner_factory(hidden_channels: int, shortcut: bool) -> nn.Module:
    ...
    The composite is the ``c3k=True`` inner unit — a :class:`~lit_yolo.models.blocks.C3k`
    with ``n=2`` and ``expansion=0.5`` — followed by a
    :class:`~lit_yolo.models.blocks.PSABlock` on its output, matching the attention
    tail of blueprint sec. 5.3. It is passed to :class:`~lit_yolo.models.blocks.C3k2`
